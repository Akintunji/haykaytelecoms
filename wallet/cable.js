    ...
    <SafeAreaView style={styles.Safeareaview}>
      <ScrollView>
        ...
        <View style={{ alignItems: "center" }}>
          <Text style={{ color: "blue", marginHorizontal: 30 }}>
          ...
          <Picker>
            ...
            <Picker.Item
              label="STARTIMES Classic - #1200 - 1 Week"
              value="40"
            />
            <Picker.Item
              label="STARTIMES Super - #1,500  - 1 Week"
              value="41"
            />
            <Picker.Item
              label="STAR TIMES Basic - #1,700  - 1 Month"
              value="12"
            />

            <Picker.Item
              label="STARTIMES Smart - #2,200  - 1 Month -"
              value="13"
            />
            <Picker.Item
              label="STARTIME Classic - #2,500  - 1 Month"
              value="11"
            />
            <Picker.Item
              label="STARTIME Super - #4,200  - 1 Month"
              value="15"
            />
            ...
            <Picker.Item
              label="DStv Compact + Extra View - ₦11950"
              value="29"
            />
            ...
            <Picker.Item
              label="DStv Premium + Extra View - ₦23982"
              value="30"
            />
...
const styles = StyleSheet.create({
  ...
  usernameinput: { fontSize: 20, fontWeight: "bold", color: "white" },
});
