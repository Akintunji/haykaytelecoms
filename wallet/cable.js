...
import { StyleSheet,TextInput , Text, View,SafeAreaView,Button,ScrollView,Alert,Image,Keyboard } from 'react-native';
...
<Text style={{color:'blue',marginHorizontal:30}}>SELECT CABLE NETWORK</Text>
 <Picker>
...
<Text style={{color:'blue',marginHorizontal:30}}>SELECT PLAN</Text>
...
<Picker.Item label = "DStv Premium Asia - ₦209000   " value = "25" />
 ...
 <Picker.Item label = "DStv Premium French - ₦29400" value = "24" />
    ...
    <TextInput 
     style={{ color: 'blue',borderWidth:2,borderradius:2,borderColor:'blue' }}
     onChangeText={(val)=>set_iuc(val)} placeholderTextColor="blue"
